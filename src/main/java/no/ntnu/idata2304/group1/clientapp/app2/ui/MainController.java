  ...
  public void start(Stage stage){
    ClientSocket clientSocket;
      ...
      try{
        ...
        textDialogHostName.setHeaderText("Please enter the host name of the server you want to connect to");
        ...
        textDialogPortNumber.setHeaderText("Please enter the port of the server you want to connect to");
        ...
        clientSocket = new ClientSocket(hostName, portNumber, "C:\\Users\\johan\\Desktop\\Group1testfolder\\src\\test\\resources\\no\\ntnu\\idata2304\\group1\\clientapp\\app2\\trustedCerts");
